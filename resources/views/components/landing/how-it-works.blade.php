...
<section id="como-funciona" class="bg-background py-16 sm:py-20">
    <div class="mx-auto max-w-7xl px-4 sm:px-6">
        ...
        <ol class="mt-12 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            @foreach ($steps as $index => $step)
                <li class="reveal group rounded-2xl border border-muted bg-surface p-5 transition duration-300 hover:-translate-y-1 hover:border-primary/40 hover:shadow-lg" style="--reveal-delay: {{ ($index + 1) * 80 }}ms">
